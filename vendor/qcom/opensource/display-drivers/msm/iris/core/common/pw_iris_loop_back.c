...
int iris_loop_back_validate(void)
{
	...
	if (pcfg->pw_chip_func_ops.iris_loop_back_validate_)
		ret = pcfg->pw_chip_func_ops.iris_loop_back_validate_();
...
int iris_mipi_rx0_validate(void)
{
	...
	if (pcfg->pw_chip_func_ops.iris_mipi_rx0_validate_)
		ret = pcfg->pw_chip_func_ops.iris_mipi_rx0_validate_();
		...
		size_t count, loff_t *ppos)
{
	...
	if (pcfg->pw_chip_func_ops.iris_set_loopback_flag_)
		pcfg->pw_chip_func_ops.iris_set_loopback_flag_(val);
		...
		size_t count, loff_t *ppos)
{
	...
	if (pcfg->pw_chip_func_ops.iris_get_loopback_flag_)
		val = pcfg->pw_chip_func_ops.iris_get_loopback_flag_();
...
int iris_dbgfs_loop_back_init(void *display)
{
	struct iris_cfg *pcfg = iris_get_cfg();
	int retval;
