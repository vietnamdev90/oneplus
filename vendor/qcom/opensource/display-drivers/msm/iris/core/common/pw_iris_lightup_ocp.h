 ...
 */
#ifndef _PW_IRIS_LIGHTUP_OCP_H_
#define _PW_IRIS_LIGHTUP_OCP_H_

#define IRIS_RD_PACKET_DATA_I5  0xF189C018
...
#define IRIS_TX_INTSTAT_RAW_I5 0xF189FFE4
...
#define IRIS_MIPI_TX_PAYLOAD_ADDR_I5  0xF189C014
...
void iris_ocp_write_mult_vals_i5(u32 size, u32 *pvalues);
u32 iris_ocp_read(u32 address, u32 type);
void iris_write_test(u32 iris_addr, int ocp_type, u32 pkt_size);
...
void iris_i2c_ocp_write_mult_vals(u32 size, u32 *pvalues);
int iris_i2c_read_panel_data(u32 reg_addr, u32 size, u32 *pvalues);
void iris_dsi_write_mult_vals(u32 size, u32 *pvalues);
void iris_i2c_write_val(u32 addr, u32 value);
