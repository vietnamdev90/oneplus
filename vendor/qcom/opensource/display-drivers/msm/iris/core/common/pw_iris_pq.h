 ...
 */
#ifndef _PW_IRIS_PQ_H_
#define _PW_IRIS_PQ_H_
...
void iris_pq_parameter_init_i5(void);
...
void iris_dpp_3dlut_control(u32 count, u32 *values);
...
void iris_cm_color_temp_set_i5(void);
u32 iris_cm_ratio_set_for_iic(void);
int iris_cm_ratio_set_i5(uint8_t skip_last);
...
void iris_cm_color_gamut_set_i5(u32 level);
...
void iris_quality_setting_off_i5(void);
...
void iris_scaler_gamma_enable_i5(bool lightup_en, u32 level);
void iris_dom_set(int mode);
void iris_dom_set_i5(int mode);
...
void iris_pwil_dpp_en_i5(bool dpp_en);
...
void iris_dpp_en_i8(bool dpp_en);
...
void iris_scurve_update_i8(u32 *buffer);
void iris_scurve_update_i7p(u32 *buffer);
...
void iris_end_blending_i8(bool bcommit);
void iris_blending_mode_set(u32 level);
void iris_cm_colortemp_mode_set_i5(u32 mode);
