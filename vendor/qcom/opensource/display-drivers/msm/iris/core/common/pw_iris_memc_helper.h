 ...
 */
#ifndef _PW_IRIS_MEMC_HELPER_
#define _PW_IRIS_MEMC_HELPER_

//#include "pw_iris_memc_helper_i8.h"

#define IRIS_RGB 0x0
#define IRIS_YUV 0x1
#define IRIS_CHROMA_444 0x0
#define IRIS_CHROMA_422 0x1
#define IRIS_CHROMA_420 0x2
