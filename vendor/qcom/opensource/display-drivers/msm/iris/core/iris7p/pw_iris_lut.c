...
load_calibrated:
	// Load "iris7p_ccf1.fw".
	strncpy(ccf1_name, IRIS_CCF1_CALIBRATED_FIRMWARE_NAME_I7P, MAX_FW_NAME_LEN - 2);
	...
	// Load "iris7p_ccf2.fw".
	strncpy(ccf2_name, IRIS_CCF2_CALIBRATED_FIRMWARE_NAME_I7P, MAX_FW_NAME_LEN - 2);
	...
	// Load "iris7p_ccf3.fw".
	strncpy(ccf3_name, IRIS_CCF3_CALIBRATED_FIRMWARE_NAME_I7P, MAX_FW_NAME_LEN - 2);
...
load_golden:
	...
	if (pcfg->ccf1_name)
		strncpy(ccf1_name, pcfg->ccf1_name, MAX_FW_NAME_LEN - 2);
	else
		strncpy(ccf1_name, IRIS_CCF1_FIRMWARE_NAME_I7P, MAX_FW_NAME_LEN - 2);
	...
	if (pcfg->ccf2_name)
		strncpy(ccf2_name, pcfg->ccf2_name, MAX_FW_NAME_LEN - 2);
	else
		strncpy(ccf2_name, IRIS_CCF2_FIRMWARE_NAME_I7P, MAX_FW_NAME_LEN - 2);
	...
	if (pcfg->ccf3_name)
		strncpy(ccf3_name, pcfg->ccf3_name, MAX_FW_NAME_LEN - 2);
	else
		strncpy(ccf3_name, IRIS_CCF3_FIRMWARE_NAME_I7P, MAX_FW_NAME_LEN - 2);
