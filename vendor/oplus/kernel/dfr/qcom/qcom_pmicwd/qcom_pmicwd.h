...
#define QPNP_PON_WD_RST_S1_TIMER(pmicwd)		(pmicwd->wd_base + 0x54)
#define QPNP_PON_WD_RST_S2_TIMER(pmicwd)		(pmicwd->wd_base + 0x55)
#define QPNP_PON_WD_RST_S2_CTL(pmicwd)			(pmicwd->wd_base + 0x56)
#define QPNP_PON_WD_RST_S2_CTL2(pmicwd)		(pmicwd->wd_base + 0x57)
#define QPNP_PON_WD_RESET_PET(pmicwd)  		(pmicwd->wd_base + 0x58)
#define QPNP_PON_RT_STS(pmicwd)				(pmicwd->wd_base + 0x10)

#define QPNP_PON_GEN3_INT_SET_TYPE(pmicwd)       (pmicwd->wd_base + 0x11)
#define QPNP_PON_GEN3_INT_POLARITY_HIGH(pmicwd)       (pmicwd->wd_base + 0x12)
#define QPNP_PON_GEN3_INT_POLARITY_LOW(pmicwd)       (pmicwd->wd_base + 0x13)
#define QPNP_PON_GEN3_INT_LATCHED_CLR(pmicwd)       (pmicwd->wd_base + 0x14)
#define QPNP_PON_GEN3_INT_EN_SET(pmicwd)       (pmicwd->wd_base + 0x15)
#define QPNP_PON_GEN3_INT_EN_CLR(pmicwd)       (pmicwd->wd_base + 0x16)
#define QPNP_PON_GEN3_WD_RST_S1_TIMER(pmicwd)       (pmicwd->wd_base + 0x4c)
#define QPNP_PON_GEN3_WD_RST_S2_TIMER(pmicwd)       (pmicwd->wd_base + 0x4d)
#define QPNP_PON_GEN3_WD_RST_S2_CTL(pmicwd)         (pmicwd->wd_base + 0x4e)
#define QPNP_PON_GEN3_WD_RST_S2_CTL2(pmicwd)        (pmicwd->wd_base + 0x4f)
#define QPNP_PON_GEN3_WD_RESET_PET(pmicwd)          (pmicwd->wd_base + 0x50)
#define PMIC_WD_INT_BIT_MASK		BIT(3)


#define QPNP_PON_GEN3_WD_BITE_TIME_LSB(pmicwd)       (pmicwd->wd_base + 0x4a)
#define QPNP_PON_GEN3_WD_BITE_TIME_MSB(pmicwd)       (pmicwd->wd_base + 0x4b)
#define QPNP_PON_GEN3_WD_INT_MID_SEL(pmicwd)       (pmicwd->wd_base + 0x1a)
#define QPNP_PON_GEN3_WD_RESET_TYPE(pmicwd)       (pmicwd->wd_base + 0x50)
#define QPNP_PON_GEN3_WD_PET(pmicwd)          (pmicwd->wd_base + 0x47)
#define QPNP_PON_GEN3_WD_ENABLE(pmicwd)          (pmicwd->wd_base + 0x46)
#define QPNP_PON_GEN3_WD_BASE 0x1500
...
static inline int dup_qpnp_pon_masked_write(struct qpnp_pon *pon, u16 addr, u8 mask, u8 val) {
        ...
        PWD_ERR("dup_qpnp_pon_masked_write, addr=0x%04X, rc=%d, val=%d\n", addr, rc, val);
        if (rc) {
...
static inline int dup_qpnp_pon_write(struct qpnp_pon *pon, u16 addr, u8 val)
{
        int rc;

        rc = regmap_write(pon->regmap, addr, val);
        PWD_ERR("dup_qpnp_pon_write, addr=0x%04X, rc=%d, val=%d\n", addr, rc, val);
        if (rc) {
                PWD_ERR("Register write failed, addr=0x%04X, rc=%d\n", addr, rc);
        }
