...
#if LINUX_VERSION_CODE >= KERNEL_VERSION(6, 12, 0)
static void dump_device_info_remove(struct platform_device *pdev)
{
	pr_err("dump_device_info, dump_device_info_remove!\n");
}
#else
...
#if LINUX_VERSION_CODE >= KERNEL_VERSION(6, 12, 0)
	.remove = dump_device_info_remove,
#else
