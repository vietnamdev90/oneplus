...
/* Register 66h */
#define	SC6607_VOOCPHY_VBUS_ERR_HI_STAT_MASK	0x04
#define	SC6607_VOOCPHY_VBUS_ERR_HI_STAT_SHIFT	2
#define	SC6607_VOOCPHY_VBUS_ERR_LO_STAT_MASK	0x02
#define	SC6607_VOOCPHY_VBUS_ERR_LO_STAT_SHIFT	1

/* Register 67h */
#define	SC6607_VOOCPHY_VBUS_ERR_HI_FLAG_MASK	0x04
#define	SC6607_VOOCPHY_VBUS_ERR_HI_FLAG_SHIFT	2
#define	SC6607_VOOCPHY_VBUS_ERR_LO_FLAG_MASK	0x02
#define	SC6607_VOOCPHY_VBUS_ERR_LO_FLAG_SHIFT	1
#define	SC6607_VOOCPHY_CP_SWITCHING_FLAG_MASK	0x01
#define	SC6607_VOOCPHY_CP_SWITCHING_FLAG_SHIFT	0
...
/* Register 6Ch */
#define SC6607_VOOCPHY_VBUS_SHORT_FLAG_MASK		0x08
#define SC6607_VOOCPHY_VBUS_SHORT_FLAG_SHIFT		3
#define SC6607_VOOCPHY_PMID2OUT_OVP_FLAG_MASK		0x04
#define SC6607_VOOCPHY_PMID2OUT_OVP_FLAG_SHIFT		2
#define SC6607_VOOCPHY_PMID2OUT_UVP_FLAG_MASK		0x02
#define SC6607_VOOCPHY_PMID2OUT_UVP_FLAG_SHIFT		1
...
#define SC6607_I2C_ERR_INFO_NUM		2
#define SC6607_I2C_ERR_ADDR		0
#define SC6607_I2C_ERR_CODE		1
#define SC6607_MAIN_I2C_ERROR		(1 << 0)
#define SC6607_IRQ_EVNET_NUM		7
