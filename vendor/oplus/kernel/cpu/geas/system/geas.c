...
int update_geas_params_type_handler(const struct ctl_table *table, int write,
...
int update_geas_params_handler(const struct ctl_table *table, int write,
			void *buffer, unsigned long *lenp, long long *ppos)
{
	int ret = 0;
	int type;
