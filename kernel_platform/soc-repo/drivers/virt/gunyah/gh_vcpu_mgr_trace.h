...
#undef TRACE_SYSTEM
#define TRACE_SYSTEM gh_vcpu_mgr
#undef TRACE_INCLUDE_PATH
#define TRACE_INCLUDE_PATH .
#undef TRACE_INCLUDE_FILE
#define TRACE_INCLUDE_FILE gh_vcpu_mgr_trace

#if !defined(_TRACE_GH_VCPU_MGR_TRACE_H) || defined(TRACE_HEADER_MULTI_READ)
#define _TRACE_GH_VCPU_MGR_TRACE_H
...
#endif /* _TRACE_GH_VCPU_MGR_TRACE_H */
