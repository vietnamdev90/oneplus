...
static struct qcom_icc_node qnm_gemnoc_cnoc = {
	...
	.noc_ops = &qcom_qnoc4_ops,
	.num_links = 13,
	.links = { SLAVE_AOSS, SLAVE_APSS,
		   SLAVE_DISPLAY_CFG, SLAVE_IPA_CFG,
		   SLAVE_IPC_ROUTER_FENCE, SLAVE_PCIE_CFG,
		   SLAVE_QRNG, SLAVE_TME_CFG,
...
static struct qcom_icc_qosbox qxm_video_qos = {
	.regs = icc_qnoc_qos_regs[ICC_QNOC_QOSGEN_TYPE_RPMH],
	.num_ports = 1,
	.offsets = { 0x31000 },
	.config = &(struct qos_config) {
...
static struct qcom_icc_node qxm_video = {
	.name = "qxm_video",
	.id = MASTER_VIDEO,
	.channels = 1,
	.buswidth = 16,
	.noc_ops = &qcom_qnoc4_ops,
	.qosbox = &qxm_video_qos,
	.num_links = 1,
	.links = { SLAVE_MNOC_SF_MEM_NOC },
};

static struct qcom_icc_qosbox qxm_video_v_cpu_qos = {
	.regs = icc_qnoc_qos_regs[ICC_QNOC_QOSGEN_TYPE_RPMH],
	.num_ports = 1,
	.offsets = { 0x36000 },
	.config = &(struct qos_config) {
...
static struct qcom_icc_node qxm_video_v_cpu = {
	.name = "qxm_video_v_cpu",
	.id = MASTER_VIDEO_V_PROC,
	.channels = 1,
	.buswidth = 8,
	.noc_ops = &qcom_qnoc4_ops,
	.qosbox = &qxm_video_v_cpu_qos,
	.num_links = 1,
	.links = { SLAVE_MNOC_SF_MEM_NOC },
};
...
static struct qcom_icc_node qhs_ipc_router_cmp_l0 = {
	.name = "qhs_ipc_router_cmp_l0",
	.id = SLAVE_IPC_ROUTER_CMP_L0,
	.channels = 1,
	.buswidth = 4,
	.noc_ops = &qcom_qnoc4_ops,
	.num_links = 0,
...
static struct qcom_icc_node qhs_ipc_router_cmp_l1 = {
	.name = "qhs_ipc_router_cmp_l1",
	.id = SLAVE_IPC_ROUTER_CMP_L1,
	.channels = 1,
	.buswidth = 4,
	.noc_ops = &qcom_qnoc4_ops,
	.num_links = 0,
...
static struct qcom_icc_node qhs_ipc_router_periph = {
	.name = "qhs_ipc_router_periph",
	.id = SLAVE_IPC_ROUTER_PERIPH,
	.channels = 1,
	.buswidth = 4,
	.noc_ops = &qcom_qnoc4_ops,
	.num_links = 0,
...
static struct qcom_icc_bcm bcm_cn0 = {
	...
	.nodes = { &qsm_cfg, &qhs_ahb2phy0,
		   ...
		   &qhs_ipc_router_cmp_l0, &qhs_ipc_router_cmp_l1,
		   &qhs_ipc_router_periph, &qhs_mss_cfg,
		   ...
		   &qhs_aoss, &qhs_apss,
		   &qhs_ipa, &qhs_ipc_router_fence,
		   &qhs_pcie_cfg, &qhs_qrng,
		   &qhs_tme_cfg, &qss_cfg,
...
static struct qcom_icc_bcm bcm_mm1 = {
	...
	.enable_mask = 0x1,
	.num_nodes = 6,
	.nodes = { &qnm_camnoc_hf, &qnm_camnoc_sf,
		   &qnm_mdss_dcp, &qxm_video,
...
static struct qcom_icc_desc vienna_aggre_noc = {
...
static struct qcom_icc_desc vienna_clk_virt = {
	.config = &icc_regmap_config,
...
static struct qcom_icc_node *cnoc_cfg_nodes[] = {
	...
	[SLAVE_IPC_ROUTER_CMP_L0] = &qhs_ipc_router_cmp_l0,
	[SLAVE_IPC_ROUTER_CMP_L1] = &qhs_ipc_router_cmp_l1,
...
static struct qcom_icc_desc vienna_cnoc_cfg = {
	.config = &icc_regmap_config,
...
static struct qcom_icc_desc vienna_cnoc_main = {
	.config = &icc_regmap_config,
...
static struct qcom_icc_desc vienna_gem_noc = {
	.config = &icc_regmap_config,
	.nodes = gem_noc_nodes,
...
static struct qcom_icc_desc vienna_lpass_ag_noc = {
	.config = &icc_regmap_config,
...
static struct qcom_icc_desc vienna_lpass_lpiaon_noc = {
	.config = &icc_regmap_config,
...
static struct qcom_icc_desc vienna_lpass_lpicx_noc = {
	.config = &icc_regmap_config,
...
static struct qcom_icc_desc vienna_mc_virt = {
	.config = &icc_regmap_config,
	.nodes = mc_virt_nodes,
...
static struct qcom_icc_node *mmss_noc_nodes[] = {
	...
	[MASTER_VIDEO] = &qxm_video,
	[MASTER_VIDEO_V_PROC] = &qxm_video_v_cpu,
...
static struct qcom_icc_desc vienna_mmss_noc = {
	.config = &icc_regmap_config,
...
static struct qcom_icc_desc vienna_nsp_noc = {
	.config = &icc_regmap_config,
	.nodes = nsp_noc_nodes,
...
static struct qcom_icc_desc vienna_pcie_anoc = {
	.config = &icc_regmap_config,
...
static struct qcom_icc_desc vienna_system_noc = {
	.config = &icc_regmap_config,
...
static int qnoc_probe(struct platform_device *pdev)
{
	...
	if (ret)
		...
		dev_info(&pdev->dev, "Registered VIENNA ICC\n");
...
MODULE_DESCRIPTION("Vienna NoC driver");
MODULE_LICENSE("GPL");
