...
static struct qcom_icc_node qnm_gemnoc_cnoc = {
	...
	.links = { SLAVE_AOSS, SLAVE_IPA_CFG,
		   SLAVE_IPC_ROUTER_FENCE, SLAVE_PCIE_CFG,
...
static struct qcom_icc_qosbox qnm_video_mvp0_qos = {
	.regs = icc_qnoc_qos_regs[ICC_QNOC_QOSGEN_TYPE_RPMH],
	.num_ports = 1,
	.offsets = { 0x28000 },
	.config = &(struct qos_config) {
...
static struct qcom_icc_node qnm_pcie_disp_crm_hw_6 = {
	.name = "qnm_pcie_disp_crm_hw_6",
	.id = MASTER_ANOC_PCIE_GEM_NOC_DISP_CRM_HW_6,
	.channels = 1,
	.buswidth = 16,
	.noc_ops = &qcom_qnoc4_ops,
	.num_links = 1,
...
static struct qcom_icc_node qnm_pcie_disp_crm_hw_7 = {
	.name = "qnm_pcie_disp_crm_hw_7",
	.id = MASTER_ANOC_PCIE_GEM_NOC_DISP_CRM_HW_7,
	.channels = 1,
	.buswidth = 16,
	.noc_ops = &qcom_qnoc4_ops,
	.num_links = 1,
...
static struct qcom_icc_node qnm_pcie_disp_crm_hw_8 = {
	.name = "qnm_pcie_disp_crm_hw_8",
	.id = MASTER_ANOC_PCIE_GEM_NOC_DISP_CRM_HW_8,
	.channels = 1,
	.buswidth = 16,
	.noc_ops = &qcom_qnoc4_ops,
	.num_links = 1,
...
static struct qcom_icc_bcm bcm_cn0 = {
	...
	.nodes = { &qsm_cfg, &qhs_ahb2phy0,
		   ...
		   &qhs_aoss, &qhs_ipa,
		   &qhs_ipc_router_fence, &qhs_pcie_cfg,
...
static struct qcom_icc_bcm bcm_mm1 = {
	...
	.nodes = { &qnm_camnoc_hf, &qnm_camnoc_nrt_icp_sf,
		   ...
		   &qnm_video_cv_cpu, &qnm_video_mvp0,
...
static struct qcom_icc_bcm bcm_sh1_disp_crm_hw_6 = {
	...
	.enable_mask = 0x1,
	.num_nodes = 2,
	.nodes = { &qnm_mnoc_hf_disp_crm_hw_6, &qnm_pcie_disp_crm_hw_6 },
};
...
static struct qcom_icc_bcm bcm_sh1_disp_crm_hw_7 = {
	...
	.enable_mask = 0x1,
	.num_nodes = 2,
	.nodes = { &qnm_mnoc_hf_disp_crm_hw_7, &qnm_pcie_disp_crm_hw_7 },
};
...
static struct qcom_icc_bcm bcm_sh1_disp_crm_hw_8 = {
	...
	.enable_mask = 0x1,
	.num_nodes = 2,
	.nodes = { &qnm_mnoc_hf_disp_crm_hw_8, &qnm_pcie_disp_crm_hw_8 },
};
...
static struct qcom_icc_desc alor_aggre1_noc = {
...
static struct qcom_icc_desc alor_aggre2_noc = {
	.config = &icc_regmap_config,
...
static struct qcom_icc_desc alor_clk_virt = {
	.config = &icc_regmap_config,
...
static struct qcom_icc_desc alor_cnoc_cfg = {
	.config = &icc_regmap_config,
...
static struct qcom_icc_desc alor_cnoc_main = {
	.config = &icc_regmap_config,
...
static struct qcom_icc_desc alor_gem_noc = {
	.config = &icc_regmap_config,
	.nodes = gem_noc_nodes,
...
static struct qcom_icc_desc alor_lpass_ag_noc = {
	.config = &icc_regmap_config,
...
static struct qcom_icc_desc alor_lpass_lpiaon_noc = {
	.config = &icc_regmap_config,
...
static struct qcom_icc_desc alor_lpass_lpicx_noc = {
	.config = &icc_regmap_config,
...
static struct qcom_icc_desc alor_mc_virt = {
	.config = &icc_regmap_config,
	.nodes = mc_virt_nodes,
...
static struct qcom_icc_node *mmss_noc_nodes[] = {
	...
	[MASTER_VIDEO_MVP] = &qnm_video_mvp0,
...
static struct qcom_icc_desc alor_mmss_noc = {
	.config = &icc_regmap_config,
...
static struct qcom_icc_desc alor_nsp_noc = {
	.config = &icc_regmap_config,
	.nodes = nsp_noc_nodes,
...
static struct qcom_icc_desc alor_pcie_anoc = {
	.config = &icc_regmap_config,
...
static struct qcom_icc_desc alor_system_noc = {
	.config = &icc_regmap_config,
...
static int qnoc_probe(struct platform_device *pdev)
{
	...
	if (ret)
		...
		dev_info(&pdev->dev, "Registered Alor ICC provider\n");

	return ret;
}

static const struct of_device_id qnoc_of_match[] = {
	{ .compatible = "qcom,alor-aggre1_noc",
	  .data = &alor_aggre1_noc},
	{ .compatible = "qcom,alor-aggre2_noc",
	  .data = &alor_aggre2_noc},
	{ .compatible = "qcom,alor-clk_virt",
	  .data = &alor_clk_virt},
	{ .compatible = "qcom,alor-cnoc_cfg",
	  .data = &alor_cnoc_cfg},
	{ .compatible = "qcom,alor-cnoc_main",
	  .data = &alor_cnoc_main},
	{ .compatible = "qcom,alor-gem_noc",
	  .data = &alor_gem_noc},
	{ .compatible = "qcom,alor-lpass_ag_noc",
	  .data = &alor_lpass_ag_noc},
	{ .compatible = "qcom,alor-lpass_lpiaon_noc",
	  .data = &alor_lpass_lpiaon_noc},
	{ .compatible = "qcom,alor-lpass_lpicx_noc",
	  .data = &alor_lpass_lpicx_noc},
	{ .compatible = "qcom,alor-mc_virt",
	  .data = &alor_mc_virt},
	{ .compatible = "qcom,alor-mmss_noc",
	  .data = &alor_mmss_noc},
	{ .compatible = "qcom,alor-nsp_noc",
	  .data = &alor_nsp_noc},
	{ .compatible = "qcom,alor-pcie_anoc",
	  .data = &alor_pcie_anoc},
	{ .compatible = "qcom,alor-system_noc",
	  .data = &alor_system_noc},
	{ }
};
...
MODULE_DESCRIPTION("Alor NoC driver");
MODULE_LICENSE("GPL");
