...
static int cam_cc_debug_mux_sels[] = {
	0x60,		/* cam_cc_cam_top_ahb_clk */
	0x5E,		/* cam_cc_cam_top_fast_ahb_clk */
	0x57,		/* cam_cc_camnoc_dcd_xo_clk */
	0x55,		/* cam_cc_camnoc_nrt_axi_clk */
	0x43,		/* cam_cc_camnoc_nrt_cre_clk */
	0x1C,		/* cam_cc_camnoc_nrt_ipe_nps_clk */
	0x13,		/* cam_cc_camnoc_nrt_ofe_main_clk */
	0x53,		/* cam_cc_camnoc_rt_axi_clk */
	0x3D,		/* cam_cc_camnoc_rt_ife_lite_clk */
	0x24,		/* cam_cc_camnoc_rt_tfe_0_main_clk */
	0x2C,		/* cam_cc_camnoc_rt_tfe_1_main_clk */
	0x34,		/* cam_cc_camnoc_rt_tfe_2_main_clk */
	0x58,		/* cam_cc_camnoc_xo_clk */
	0x4E,		/* cam_cc_cci_0_clk */
	0x4F,		/* cam_cc_cci_1_clk */
	0x50,		/* cam_cc_cci_2_clk */
	0x5B,		/* cam_cc_core_ahb_clk */
	0x44,		/* cam_cc_cre_ahb_clk */
	0x42,		/* cam_cc_cre_clk */
	...
	0x4C,		/* cam_cc_icp_0_ahb_clk */
	0x48,		/* cam_cc_icp_0_clk */
	0x4D,		/* cam_cc_icp_1_ahb_clk */
	0x4A,		/* cam_cc_icp_1_clk */
	0x41,		/* cam_cc_ife_lite_ahb_clk */
	0x3B,		/* cam_cc_ife_lite_clk */
	0x40,		/* cam_cc_ife_lite_cphy_rx_clk */
	0x3E,		/* cam_cc_ife_lite_csid_clk */
	0x20,		/* cam_cc_ipe_nps_ahb_clk */
	0x1A,		/* cam_cc_ipe_nps_clk */
	0x21,		/* cam_cc_ipe_nps_fast_ahb_clk */
	0x1D,		/* cam_cc_ipe_pps_clk */
	0x22,		/* cam_cc_ipe_pps_fast_ahb_clk */
	0x45,		/* cam_cc_jpeg_clk */
	0x11,		/* cam_cc_ofe_ahb_clk */
	0x15,		/* cam_cc_ofe_anchor_clk */
	0xF,		/* cam_cc_ofe_anchor_fast_ahb_clk */
	0x17,		/* cam_cc_ofe_hdr_clk */
	0x10,		/* cam_cc_ofe_hdr_fast_ahb_clk */
	0x12,		/* cam_cc_ofe_main_clk */
	0xE,		/* cam_cc_ofe_main_fast_ahb_clk */
	0x59,		/* cam_cc_qdss_debug_clk */
	0x5A,		/* cam_cc_qdss_debug_xo_clk */
	0x26,		/* cam_cc_tfe_0_bayer_clk */
	0x2A,		/* cam_cc_tfe_0_bayer_fast_ahb_clk */
	0x23,		/* cam_cc_tfe_0_main_clk */
	0x29,		/* cam_cc_tfe_0_main_fast_ahb_clk */
	0x2E,		/* cam_cc_tfe_1_bayer_clk */
	0x32,		/* cam_cc_tfe_1_bayer_fast_ahb_clk */
	0x2B,		/* cam_cc_tfe_1_main_clk */
	0x31,		/* cam_cc_tfe_1_main_fast_ahb_clk */
	0x36,		/* cam_cc_tfe_2_bayer_clk */
	0x3A,		/* cam_cc_tfe_2_bayer_fast_ahb_clk */
	0x33,		/* cam_cc_tfe_2_main_clk */
	0x39,		/* cam_cc_tfe_2_main_fast_ahb_clk */
	0x63,		/* cam_cc_tracenoc_tpdm_1_cmb_clk */
	0x64,		/* measure_only_cam_cc_drv_ahb_clk */
	0x62,		/* measure_only_cam_cc_drv_xo_clk */
	0x5C,		/* measure_only_cam_cc_gdsc_clk */
	0x5D,		/* measure_only_cam_cc_sleep_clk */
};

static struct clk_debug_mux cam_cc_debug_mux = {
	.priv = &debug_mux_priv,
	.debug_offset = 0x26000,
	.post_div_offset = 0x22004,
	.cbcr_offset = 0x22008,
	.src_sel_mask = 0xFF,
	.src_sel_shift = 0,
	.post_div_mask = 0xF,
...
static int disp_cc_debug_mux_sels[] = {
	0x38,		/* disp_cc_esync0_clk */
	0x39,		/* disp_cc_esync1_clk */
	0x4F,		/* disp_cc_mdss_accu_shift_clk */
	0x3D,		/* disp_cc_mdss_ahb1_clk */
	0x36,		/* disp_cc_mdss_ahb_clk */
	0x35,		/* disp_cc_mdss_ahb_swi_clk */
	0x16,		/* disp_cc_mdss_byte0_clk */
	0x17,		/* disp_cc_mdss_byte0_intf_clk */
	0x18,		/* disp_cc_mdss_byte1_clk */
	0x19,		/* disp_cc_mdss_byte1_intf_clk */
	0x22,		/* disp_cc_mdss_dptx0_aux_clk */
	0x1F,		/* disp_cc_mdss_dptx0_crypto_clk */
	0x1C,		/* disp_cc_mdss_dptx0_link_clk */
	0x1E,		/* disp_cc_mdss_dptx0_link_intf_clk */
	0x20,		/* disp_cc_mdss_dptx0_pixel0_clk */
	0x21,		/* disp_cc_mdss_dptx0_pixel1_clk */
	0x1D,		/* disp_cc_mdss_dptx0_usb_router_link_intf_clk */
	0x29,		/* disp_cc_mdss_dptx1_aux_clk */
	0x28,		/* disp_cc_mdss_dptx1_crypto_clk */
	0x25,		/* disp_cc_mdss_dptx1_link_clk */
	0x27,		/* disp_cc_mdss_dptx1_link_intf_clk */
	0x23,		/* disp_cc_mdss_dptx1_pixel0_clk */
	0x24,		/* disp_cc_mdss_dptx1_pixel1_clk */
	0x26,		/* disp_cc_mdss_dptx1_usb_router_link_intf_clk */
	0x2F,		/* disp_cc_mdss_dptx2_aux_clk */
	0x2E,		/* disp_cc_mdss_dptx2_crypto_clk */
	0x2C,		/* disp_cc_mdss_dptx2_link_clk */
	0x2D,		/* disp_cc_mdss_dptx2_link_intf_clk */
	0x2A,		/* disp_cc_mdss_dptx2_pixel0_clk */
	0x2B,		/* disp_cc_mdss_dptx2_pixel1_clk */
	0x33,		/* disp_cc_mdss_dptx3_aux_clk */
	0x34,		/* disp_cc_mdss_dptx3_crypto_clk */
	0x31,		/* disp_cc_mdss_dptx3_link_clk */
	0x32,		/* disp_cc_mdss_dptx3_link_intf_clk */
	0x30,		/* disp_cc_mdss_dptx3_pixel0_clk */
	0x1A,		/* disp_cc_mdss_esc0_clk */
	0x1B,		/* disp_cc_mdss_esc1_clk */
	0x3A,		/* disp_cc_mdss_mdp1_clk */
	0x12,		/* disp_cc_mdss_mdp_clk */
	0x3B,		/* disp_cc_mdss_mdp_lut1_clk */
	0x13,		/* disp_cc_mdss_mdp_lut_clk */
	0x14,		/* disp_cc_mdss_mdp_ss_ip_clk */
	0x3E,		/* disp_cc_mdss_non_gdsc_ahb_clk */
...
static int eva_cc_debug_mux_sels[] = {
	...
	0xB,		/* eva_cc_mvs0_shift_clk */
	0x1,		/* eva_cc_mvs0c_clk */
	0x2,		/* eva_cc_mvs0c_freerun_clk */
	0xC,		/* eva_cc_mvs0c_shift_clk */
	0x8,		/* measure_only_eva_cc_ahb_clk */
	0xD,		/* measure_only_eva_cc_sleep_clk */
	0xA,		/* measure_only_eva_cc_ts_xo_clk */
...
static const char *const gcc_debug_mux_parent_names[] = {
	...
	"gcc_qupv3_wrap3_ibi_ctrl_1_clk",
	"gcc_qupv3_wrap3_ibi_ctrl_2_clk",
	"gcc_qupv3_wrap3_s0_clk",
	"gcc_qupv3_wrap3_s1_clk",
	"gcc_qupv3_wrap3_s2_clk",
	"gcc_qupv3_wrap3_s3_clk",
	"gcc_qupv3_wrap3_s4_clk",
	"gcc_qupv3_wrap3_s5_clk",
	"gcc_qupv3_wrap4_core_2x_clk",
	"gcc_qupv3_wrap4_core_clk",
	"gcc_qupv3_wrap4_s0_clk",
	"gcc_qupv3_wrap4_s1_clk",
	"gcc_qupv3_wrap4_s2_clk",
	"gcc_qupv3_wrap4_s3_clk",
	"gcc_qupv3_wrap4_s4_clk",
	"gcc_qupv3_wrap_1_m_axi_clk",
	"gcc_qupv3_wrap_1_s_ahb_clk",
	"gcc_qupv3_wrap_2_m_ahb_clk",
	"gcc_qupv3_wrap_2_s_ahb_clk",
	"gcc_qupv3_wrap_3_ibi_1_ahb_clk",
	"gcc_qupv3_wrap_3_ibi_2_ahb_clk",
	"gcc_qupv3_wrap_3_m_ahb_clk",
	"gcc_qupv3_wrap_3_s_ahb_clk",
	"gcc_qupv3_wrap_4_m_ahb_clk",
	"gcc_qupv3_wrap_4_s_ahb_clk",
	"gcc_sdcc2_ahb_clk",
	"gcc_sdcc2_apps_clk",
	"gcc_sdcc4_ahb_clk",
	"gcc_sdcc4_apps_clk",
...
static int gcc_debug_mux_sels[] = {
	0x160,		/* apss_cc_debug_mux */
	0x7B,		/* cam_bist_mclk_cc_debug_mux */
	0x79,		/* cam_cc_debug_mux */
	0x7F,		/* disp_cc_debug_mux */
	0x8F,		/* eva_cc_debug_mux */
	0x49,		/* gcc_aggre_noc_pcie_axi_clk */
	0x4B,		/* gcc_aggre_ufs_phy_axi_clk */
	0x4A,		/* gcc_aggre_usb3_prim_axi_clk */
	0x105,		/* gcc_boot_rom_ahb_clk */
	0x74,		/* gcc_camera_hf_axi_clk */
	0x76,		/* gcc_camera_sf_axi_clk */
	0x34,		/* gcc_cfg_noc_pcie_anoc_ahb_clk */
	...
	0x8D,		/* gcc_eva_axi0c_clk */
	0x171,		/* gcc_gp1_clk */
	0x172,		/* gcc_gp2_clk */
	0x173,		/* gcc_gp3_clk */
	0x1B1,		/* gcc_gpu_gemnoc_gfx_clk */
	0x1B3,		/* gcc_gpu_gpll0_clk_src */
	0x1B4,		/* gcc_gpu_gpll0_div_clk_src */
	0x179,		/* gcc_pcie_0_aux_clk */
	0x178,		/* gcc_pcie_0_cfg_ahb_clk */
	0x177,		/* gcc_pcie_0_mstr_axi_clk */
	0x17A,		/* gcc_pcie_0_phy_aux_clk */
	0x17C,		/* gcc_pcie_0_phy_rchng_clk */
	0x17B,		/* gcc_pcie_0_pipe_clk */
	0x176,		/* gcc_pcie_0_slv_axi_clk */
	0x175,		/* gcc_pcie_0_slv_q2a_axi_clk */
	0xF5,		/* gcc_pdm2_clk */
	...
	0xC3,		/* gcc_qupv3_i2c_s2_clk */
	0xC4,		/* gcc_qupv3_i2c_s3_clk */
	0xC5,		/* gcc_qupv3_i2c_s4_clk */
	0xBF,		/* gcc_qupv3_i2c_s_ahb_clk */
	0xC9,		/* gcc_qupv3_wrap1_core_2x_clk */
	0xC8,		/* gcc_qupv3_wrap1_core_clk */
	0xD2,		/* gcc_qupv3_wrap1_qspi_ref_clk */
	0xCA,		/* gcc_qupv3_wrap1_s0_clk */
	0xCB,		/* gcc_qupv3_wrap1_s1_clk */
	0xCC,		/* gcc_qupv3_wrap1_s2_clk */
	0xCD,		/* gcc_qupv3_wrap1_s3_clk */
	0xCE,		/* gcc_qupv3_wrap1_s4_clk */
	0xCF,		/* gcc_qupv3_wrap1_s5_clk */
	0xD0,		/* gcc_qupv3_wrap1_s6_clk */
	0xD1,		/* gcc_qupv3_wrap1_s7_clk */
	0xD6,		/* gcc_qupv3_wrap2_core_2x_clk */
	0xD5,		/* gcc_qupv3_wrap2_core_clk */
	0xD7,		/* gcc_qupv3_wrap2_s0_clk */
	0xD8,		/* gcc_qupv3_wrap2_s1_clk */
	0xD9,		/* gcc_qupv3_wrap2_s2_clk */
	0xDA,		/* gcc_qupv3_wrap2_s3_clk */
	0xDB,		/* gcc_qupv3_wrap2_s4_clk */
	0xDF,		/* gcc_qupv3_wrap3_core_2x_clk */
	0xDE,		/* gcc_qupv3_wrap3_core_clk */
	0xE8,		/* gcc_qupv3_wrap3_ibi_ctrl_1_clk */
	0xE9,		/* gcc_qupv3_wrap3_ibi_ctrl_2_clk */
	0xE0,		/* gcc_qupv3_wrap3_s0_clk */
	0xE1,		/* gcc_qupv3_wrap3_s1_clk */
	0xE2,		/* gcc_qupv3_wrap3_s2_clk */
	0xE3,		/* gcc_qupv3_wrap3_s3_clk */
	0xE4,		/* gcc_qupv3_wrap3_s4_clk */
	0xE5,		/* gcc_qupv3_wrap3_s5_clk */
	0xED,		/* gcc_qupv3_wrap4_core_2x_clk */
	0xEC,		/* gcc_qupv3_wrap4_core_clk */
	0xEE,		/* gcc_qupv3_wrap4_s0_clk */
	0xEF,		/* gcc_qupv3_wrap4_s1_clk */
	0xF0,		/* gcc_qupv3_wrap4_s2_clk */
	0xF1,		/* gcc_qupv3_wrap4_s3_clk */
	0xF2,		/* gcc_qupv3_wrap4_s4_clk */
	0xC6,		/* gcc_qupv3_wrap_1_m_axi_clk */
	0xC7,		/* gcc_qupv3_wrap_1_s_ahb_clk */
	0xD3,		/* gcc_qupv3_wrap_2_m_ahb_clk */
	0xD4,		/* gcc_qupv3_wrap_2_s_ahb_clk */
	0xE6,		/* gcc_qupv3_wrap_3_ibi_1_ahb_clk */
	0xE7,		/* gcc_qupv3_wrap_3_ibi_2_ahb_clk */
	0xDC,		/* gcc_qupv3_wrap_3_m_ahb_clk */
	0xDD,		/* gcc_qupv3_wrap_3_s_ahb_clk */
	0xEA,		/* gcc_qupv3_wrap_4_m_ahb_clk */
	0xEB,		/* gcc_qupv3_wrap_4_s_ahb_clk */
	0xBA,		/* gcc_sdcc2_ahb_clk */
	0xB9,		/* gcc_sdcc2_apps_clk */
	0xBD,		/* gcc_sdcc4_ahb_clk */
	0xBC,		/* gcc_sdcc4_apps_clk */
	0x180,		/* gcc_ufs_phy_ahb_clk */
	0x17F,		/* gcc_ufs_phy_axi_clk */
	0x186,		/* gcc_ufs_phy_ice_core_clk */
	0x187,		/* gcc_ufs_phy_phy_aux_clk */
	0x182,		/* gcc_ufs_phy_rx_symbol_0_clk */
	0x188,		/* gcc_ufs_phy_rx_symbol_1_clk */
	0x181,		/* gcc_ufs_phy_tx_symbol_0_clk */
	0x185,		/* gcc_ufs_phy_unipro_core_clk */
	0xAC,		/* gcc_usb30_prim_master_clk */
	0xAE,		/* gcc_usb30_prim_mock_utmi_clk */
	0xAD,		/* gcc_usb30_prim_sleep_clk */
	0xB0,		/* gcc_usb3_prim_phy_aux_clk */
	0xB1,		/* gcc_usb3_prim_phy_com_aux_clk */
	0xB2,		/* gcc_usb3_prim_phy_pipe_clk */
	0x87,		/* gcc_video_axi0_clk */
	0x88,		/* gcc_video_axi1_clk */
	0x1B0,		/* gpu_cc_debug_mux */
	0x131,		/* mc_cc_debug_mux */
	0x17,		/* measure_only_cnoc_clk */
	0x7A,		/* measure_only_gcc_cam_bist_mclk_ahb_clk */
	0x70,		/* measure_only_gcc_camera_ahb_clk */
	0x78,		/* measure_only_gcc_camera_xo_clk */
	0x7C,		/* measure_only_gcc_disp_ahb_clk */
	0x8B,		/* measure_only_gcc_eva_ahb_clk */
	0x8E,		/* measure_only_gcc_eva_xo_clk */
	0x1AD,		/* measure_only_gcc_gpu_cfg_ahb_clk */
	0x1D1,		/* measure_only_gcc_pcie_rscc_cfg_ahb_clk */
	0x1D2,		/* measure_only_gcc_pcie_rscc_xo_clk */
	0x82,		/* measure_only_gcc_video_ahb_clk */
	0x89,		/* measure_only_gcc_video_xo_clk */
	0x19B,		/* measure_only_ipa_2x_clk */
	0x127,		/* measure_only_memnoc_clk */
	0x17D,		/* measure_only_pcie_0_pipe_clk */
	0xC,		/* measure_only_snoc_clk */
	0x184,		/* measure_only_ufs_phy_rx_symbol_0_clk */
	0x18A,		/* measure_only_ufs_phy_rx_symbol_1_clk */
	0x183,		/* measure_only_ufs_phy_tx_symbol_0_clk */
	0xB6,		/* measure_only_usb3_phy_wrapper_gcc_usb30_pipe_clk */
	0x8A,		/* video_cc_debug_mux */
};
...
static int gpu_cc_debug_mux_sels[] = {
	...
	0x27,		/* measure_only_gpu_cc_rscc_hub_aon_clk */
...
static int gx_clkctl_debug_mux_sels[] = {
	...
	0x14,		/* measure_only_gx_clkctl_ahb_ff_clk */
	0x15,		/* measure_only_gx_clkctl_acd_ahb_ff_clk */
	0x16,		/* measure_only_gx_clkctl_rcg_ahb_ff_clk */
};
...
static int video_cc_debug_mux_sels[] = {
	...
	0x1,		/* video_cc_mvs0a_clk */
	0x2,		/* video_cc_mvs0a_freerun_clk */
...
static struct clk_dummy measure_only_eva_cc_ts_xo_clk = {
	.rrate = 1000,
	.hw.init = &(const struct clk_init_data){
		.name = "measure_only_eva_cc_ts_xo_clk",
		.ops = &clk_dummy_ops,
	},
};
...
static struct clk_hw *debugcc_canoe_hws[] = {
	...
	&measure_only_eva_cc_ts_xo_clk.hw,
...
static const struct of_device_id clk_debug_match_table[] = {
	{ .compatible = "qcom,canoe-debugcc" },
	{ }
};

static int clk_debug_canoe_probe(struct platform_device *pdev)
{
	struct clk *clk;
	int ret = 0, i;
	...
	for (i = 0; i < ARRAY_SIZE(debugcc_canoe_hws); i++) {
		clk = devm_clk_register(&pdev->dev, debugcc_canoe_hws[i]);
		if (IS_ERR(clk)) {
			dev_err(&pdev->dev, "Unable to register %s, err:(%ld)\n",
				qcom_clk_hw_get_name(debugcc_canoe_hws[i]),
				PTR_ERR(clk));
			return PTR_ERR(clk);
		}
	}
...
static int __init clk_debug_canoe_init(void)
{
	return platform_driver_register(&clk_debug_driver);
}
fs_initcall(clk_debug_canoe_init);

MODULE_DESCRIPTION("QTI DEBUG CC CANOE Driver");
MODULE_LICENSE("GPL");
