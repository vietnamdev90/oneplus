...
int ghs_habhyp_commdev_create_dispatcher(struct physical_channel *pchan)
{
...
void ghs_habhyp_commdev_dealloc_os(void *commdev)
{
...
int ghs_hab_hypervisor_register_os(void)
{
...
void ghs_dump_hab_wq(struct physical_channel *pchan) {};
void ghs_hab_pipe_read_dump(struct physical_channel *pchan) {};
int ghs_hab_stat_log(struct physical_channel **pchans, int pchan_cnt, char *dest,
			int dest_size)
{
	return 0;
};
